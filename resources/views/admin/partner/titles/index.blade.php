...
{{-- Title --}}
@section('title')
    {{ config('app.name') }} | Partner titles
            ...
            <div class="col-md-12 m-auto">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> Update Partner titles</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="title1">Title One<span class="text-danger"> *</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="description1">Description One<span class="text-danger"> *</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="title2">Title Two<span class="text-danger"> *</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="description2">Description Two<span class="text-danger"> *</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="description3">Description Three<span class="text-danger"> *</span></label>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary mr-1">Update partner Titles</button>
                                </div>
                            </div>
                        </form>
                    </div>
