...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">{{ __('Liked') }}</li>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="data_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
                                <td><a href="{{ route('user', $like->user_id ?? '') }}">{{ App\Models\User::find($like->user_id)->name ?? 'N/A'}}</a></td>
                                <td><a href="{{ route('item_details',$like->getItem->slug ?? '') }}">{{ $like->getItem->name ?? 'N/A'}}</a></td>
                                <td>
                                    <div class="dropdown">
                    ...
                    <a class="btn mt-1 btn-success" href="{{ route('liked_items') }}">{{ __('Return Back') }}</a>
                </div>
            </div>
        </div>
    </div>
