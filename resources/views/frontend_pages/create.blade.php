            ...
            <div class="mx-auto max-w-[48.125rem]">
              ...
              <div class="mb-6">
                ...
                <textarea
                  ...
                  rows="4"
                  required
                  placeholder="Provide a detailed description of your item.">{{ old('description') }}</textarea>
              </div>
              ...
              <div class="mb-6 mt-2">
                ...
                <div class="mb-3 flex items-center space-x-2">
                  <p class="dark:text-jacarta-300 text-2xs">
                    The price of the items must be a number or 2 d.p.!
                    <span
                      class="inline-block"
                      data-tippy-content="Setting your asset as explicit and sensitive content, like pornography and other not safe for work (NSFW) content, will protect users with safe search while browsing Xhibiter."
                    >
                ...
                <input
                  ...
                  id="item-supply" name="price" value="{{ old('price') }}"
                  class="dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 w-full rounded-lg py-3 hover:ring-2 dark:text-white"
                  placeholder/>
              </div>
              ...
              <div class="mb-6">
                ...
                <input
                  ...
                  id="item-date" value="{{ old('expire_date') }}"
                  class="dark:bg-jacarta-700 border-jacarta-100 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:placeholder:text-jacarta-300 w-full rounded-lg py-3 hover:ring-2 dark:text-white"
                />
              </div>
              ...
              <div class="mb-6">
                ...
                <div class="dropdown relative mb-4 cursor-pointer">
                    <input type="hidden" name="blockchain" class="dropdown-input" value="{{ old('blockchain') }}">
                  <div
                    ...
                    <span class="flex items-center">
                      ...
                      <span disabled class="dropdown-toggle__text">Select One</span>
                    </span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
              ...
              <!-- Submit -->
              <button type="submit"
                class="cursor-default bg-accent hover:bg-accent-dark rounded-full py-3 px-8 text-center font-semibold text-white transition-all" style="cursor: pointer">
                Create
              </button>
            </div>
  ...
  <div class="modal fade" id="levelsModal" tabindex="-1" aria-labelledby="addLevelsLabel" aria-hidden="true">
    <div class="modal-dialog max-w-2xl">
      <div class="modal-content">
        ...
        <div class="modal-body p-6">
          ...
          <div class="relative my-3 flex items-center">
            ...
            <div class="flex w-1/2 items-end">
              <div class="flex-1">
                <label class="font-display text-jacarta-700 mb-3 block text-base font-semibold dark:text-white" >Value</label>
                <input type="number" class="dark:bg-jacarta-700 dark:border-jacarta-600 focus:ring-accent border-jacarta-100 dark:placeholder-jacarta-300 h-12 w-full border focus:ring-inset dark:text-white" placeholder="0" />
              </div>
              ...
              <div class="flex-1 self-end">
                <input type="number" class="dark:bg-jacarta-700 dark:border-jacarta-600 focus:ring-accent border-jacarta-100 dark:placeholder-jacarta-300 h-12 w-full rounded-r-lg border focus:ring-inset dark:text-white" placeholder="0" />
              </div>
            </div>
          </div>

          <button class="hover:bg-accent border-accent text-accent mt-2 rounded-full border-2 py-2 px-8 text-center text-sm font-semibold transition-all hover:text-white">
            Add More
          </button>
        </div>
        <!-- end body -->
        ...
        <div class="modal-footer">
          <div class="flex items-center justify-center space-x-4">
            <button type="button" class="bg-accent shadow-accent-volume hover:bg-accent-dark rounded-full py-3 px-8 text-center font-semibold text-white transition-all">
              Save
            </button>
          </div>
        </div>
