@extends('layouts.dashboard')
    ...
    {{-- Title --}}
    @section('title')
        {{ config('app.name') }} | Platform Status
    @endsection
        ...
        <div class="breadcrumb-wrapper">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <a href="#">Update Platform Titles</a>
                </li>
            </ol>
        </div>
    @endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('platformTitles.update', $platforms->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-2">
                            <label class="form-label">Operation Title<span class="text-danger"> *</span></label>
                        ...
                        <div class="form-group mt-2">
                            <label class="form-label">History Title<span class="text-danger"> *</span></label>
