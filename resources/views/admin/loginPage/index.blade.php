      ...
      <div class="col-lg-12">
        <div class="card shadow">
          <div class="card-header">
            <h4 class="card-title">Update Login Interface</h4>
          </div>
          <div class="card-body">
            <form method="POST" action="{{ route('login.page.design.update', $loginPage->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="login_sub_title">Login Sub Title</label>
                    ...
                    <div class="col-lg-9">
                        <div class="form-group mt-2">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="favicon">Choose logo</label>
                            </div>
                            @error('logo')
                    ...
                    <div class="col-lg-9">
                        <div class="form-group mt-2">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="favicon">Choose Banner Image</label>
                            </div>
                            @error('banner_image')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
