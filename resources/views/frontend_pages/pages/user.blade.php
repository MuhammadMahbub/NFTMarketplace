...
<main>
    <!-- Banner -->
    <div class="relative">
      <img src="{{ asset('uploads/images/users') }}/{{ $user->cover_photo_path ?? 'default.jpg' }}" alt="banner" class="h-[18.75rem] object-cover" style="width: 100%"/>
    </div>
    <!-- end banner -->
    ...
    <section class="dark:bg-jacarta-800 bg-light-base relative pb-12 pt-28">
      ...
      <div class="container">
        <div class="text-center">
          ...
          >
            ...
            <button
              class="js-copy-clipboard dark:text-jacarta-200 max-w-[10rem] select-none overflow-hidden text-ellipsis whitespace-nowrap"
          ...
          <div class="mb-8">
            <span class="text-jacarta-400 text-sm font-bold">Joined: </span>
            <a class="text-accent text-sm font-bold">{{ $user->created_at->diffForHumans() ?? '' }}</a>
          </div>

          @php
            $like_exist = App\Models\LikeUser::where('creator_id', $user->id)->where('user_id', Auth::id())->first();
            $like_count = App\Models\LikeUser::where('creator_id', $user->id)->count();
          @endphp
          ...
          >
          @auth
          <a style="cursor: pointer" class="like_user_btn" creator_id="{{ $user->id }}">
              <span class="like_user_icon">
                  @if($like_exist)
          ...
          <span class="likeUserCount" class="dark:text-jacarta-200 text-sm">{{ $like_count }}</span>
          @else
              <a style="cursor: pointer" data-bs-toggle="modal"
              data-bs-target="#loginModal{{ $user->id }}">
                  <span>
                      <i class="fa-regular fa-heart"></i>
                  </span>
              </a>
            ...
            <div class="modal-dialog max-w-2xl">
                ...
                <div class="modal-body p-6 text-center">
                    <form>
                        ...
                        <input type="hidden" class="report_to" name="report_to" value="{{ $user->id }}">
                        <div class="dropdown my-1 cursor-pointer">
                            ...
                            <button type="button"
                                ...
                                class="bg-accent shadow-accent-volume hover:bg-accent-dark rounded-full py-3 px-8 text-center font-semibold text-white transition-all submit_report">
                                {{ __('Submit') }}
                            </button>
                        </div>
                    </form>
      ...
      @push('modals')
        <div class="modal loginModal fade" id="loginModal{{ $user->id }}" tabindex="-1" aria-labelledby="placeBidLabel" aria-hidden="true">
            <form>
                <div class="modal-dialog max-w-2xl">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body p-6">
                            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                ...
                                <div
                                    ...
                                    type="email"
                                    name="email"
                                    class="email{{ $user->id }} focus:ring-accent h-12 w-full flex-[3] border-0 focus:ring-inset"
                                    placeholder="Email"
                                    />
                                </div>
                                <div class="mb-2 flex items-center justify-between">
                                ...
                                <div
                                    ...
                                    name="password"
                                    data-id="{{ $user->id }}"
                                    class="login__Input password{{ $user->id }} focus:ring-accent h-12 w-full flex-[3] border-0 focus:ring-inset"
                                ...
                                <div class="flex items-center justify-center space-x-4">
                                    <a
                                        ...
                                        class="placeBidBtn loginFromBid loginFrom__Bid{{ $user->id }} bg-accent shadow-accent-volume hover:bg-accent-dark rounded-full py-3 px-8 text-center font-semibold text-white transition-all"
                                        >
                                        {{ __('Login') }}
                                    </a>
                                </div>
      ...
      <div class="container">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade show active" id="on-sale" role="tabpanel" aria-labelledby="on-sale-tab">
            <!-- Filters -->
            <div class="dropdown mb-8 flex flex-wrap items-center justify-between">
              <div class="flex flex-wrap items-center">
                <!-- Collections -->

                <!-- Category -->
                <div class="my-1 mr-2.5">
                  <button class="dropdown__cat__text group dropdown-toggle dark:border-jacarta-600 dark:bg-jacarta-700 group dark:hover:bg-accent hover:bg-accent border-jacarta-100 font-display text-jacarta-700 flex h-9 items-center rounded-lg border bg-white px-4 text-sm font-semibold transition-colors hover:border-transparent hover:text-white dark:text-white"
                  ...
                  <div class="dropdown-menu dark:bg-jacarta-800 z-10 hidden min-w-[220px] whitespace-nowrap rounded-xl bg-white py-4 px-2 text-left shadow-xl"
                    ...
                    <ul class="flex flex-col flex-wrap">
                      <li>
                          <a user_id="{{ $user->id }}" cat_id="all"
                            style="cursor:pointer" class="dropdown__text__cat  dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white active active_cat_class category_active" id="allItemsUser" >
                          <span>All</span>
                          {{-- <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                      ...
                      <li>
                        <a style="cursor:pointer"
                            cat_id="{{ $cat->id }}"
                            user_id="{{ $user->id }}"
                            class="dropdown__text__cat filterByUser dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white category_active">
                            {{ $cat->name }}
                        </a>
                      </li>
                      @endforeach
                ...
                <!-- Price Range -->
                <form action="{{ route('search_price_by_user') }}" method="POSt">
                    @csrf
                    <div class="my-1 mr-2.5">
                        ...
                        <div class="dropdown-menu dark:bg-jacarta-800 z-10 hidden min-w-[220px] whitespace-nowrap rounded-xl bg-white py-4 px-2 text-left shadow-xl"
                          ...
                          <div class="flex items-center space-x-3 px-5 pb-2" id="range_value">
                            ...
                            <input
                              type="number" name="min_amount" id="min_amount"
                              placeholder="From"
                              class="text-jacarta-700 placeholder-jacarta-500 focus:ring-accent border-jacarta-100 w-full max-w-[7.5rem] rounded-lg border py-[0.6875rem] px-4 dark:border-transparent dark:bg-white/[.15] dark:text-white dark:placeholder-white" value="{{ old('min_amount') }}"
                            />
                            <input
                          ...
                          <!-- Clear / Apply -->
                          <div
                            class="dark:border-jacarta-600 border-jacarta-100 -ml-2 -mr-2 mt-4 flex items-center justify-center space-x-3 border-t px-7 pt-4" id="range_wise_item"
                          >
                            {{-- <button
                              type="button"
              ...
              <div class="dropdown my-1 cursor-pointer">
                ...
                <div class="dropdown-menu dark:bg-jacarta-800 z-10 hidden min-w-[220px] whitespace-nowrap rounded-xl bg-white py-4 px-2 text-left shadow-xl"
                  ...
                  <button user_id={{ $user->id }}
                    class="dropdown__text dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center justify-between rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white" id="RecentlyAddedUser">
                    Recently Added
                    {{-- <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <button user_id={{ $user->id }}
                    class="dropdown__text dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center justify-between rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white" id="LowToHigh">
                    Price: Low to High
                  </button>

                  <button user_id={{ $user->id }}
                    class="dropdown__text dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center justify-between rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white" id="HighToLow">
                    Price: High to Low
                  </button>
            ...
            <!-- Grid -->
            <div class="grid grid-cols-1 gap-[1.875rem] md:grid-cols-2 lg:grid-cols-4" id="filterByCategoryDiv">

                @include('frontend_pages.resources.filterByUser')
            ...
            <div class="grid grid-cols-1 gap-[1.875rem] md:grid-cols-2 lg:grid-cols-4">
              ...
              <article>
                <div
                  ...
                  <div class="mt-7 flex items-center justify-between">
                    <a href="item.html">
                      <span class="font-display text-jacarta-700 hover:text-accent text-base dark:text-white" >Artof Eve</span >
                    </a>
                    <div class="dark:hover:bg-jacarta-600 dropup hover:bg-jacarta-100 rounded-full">
                      <a href="#"
                        class="dropdown-toggle inline-flex h-8 w-8 items-center justify-center text-sm"
              ...
              <article>
                <div
                  ...
                  <figure class="relative">
                    <a href="item.html">
                      <img src="{{ asset('frontend_assets') }}/img/products/item_9.jpg"
                        alt="item 9"
                        class="w-full rounded-[0.625rem]"
                        loading="lazy" />
                    </a>
                    ...
                    <div class="absolute left-3 -bottom-3">
                      <div class="flex -space-x-2">
                        <a href="#">
                          <img src="{{ asset('frontend_assets') }}/img/avatars/creator_6.png"
                            alt="creator"
                            class="dark:border-jacarta-600 hover:border-accent dark:hover:border-accent h-6 w-6 rounded-full border-2 border-white"
                            data-tippy-content="Creator: Sussygirl" />
                        </a>
            ...
            <div class="mb-8 flex flex-wrap items-center justify-between">
              <div class="flex flex-wrap items-center">
                ...
                <div class="my-1 mr-2.5">
                  ...
                  <div class="dropdown-menu dark:bg-jacarta-800 z-10 hidden min-w-[280px] whitespace-nowrap rounded-xl bg-white py-4 px-2 text-left shadow-xl"
              ...
              <article>
                <div
                  ...
                  <a href="{{ route('item_details', $item->slug ?? '') }}">
                    <span class="w-[100%]">
                      <img src="{{ asset('uploads/items') }}/{{ $item->image ?? 'default.jpg'}}"
                        alt="item 1"
                  ...
                  <div class="mt-2 flex items-center justify-between text-sm font-medium tracking-tight">
                    ...
                    <span class="dark:text-jacarta-300 text-sm">{{ App\Models\Item::where('creator_id',$user->id)->count() }} Items</span>
                  </div>
                </div>
              </article>
            @endforeach
          ...
          <div class="tab-pane fade" id="activity" role="tabpanel" aria-labelledby="activity-tab">
            ...
            <div class="lg:flex">
              <!-- Records -->
              @php
                $creator = App\Models\Item::where('status','show')->where('creator_id', $user->id)->get();
              @endphp
              <div class="mb-10 shrink-0 basis-8/12 space-y-5 lg:mb-0 lg:pr-10 bid_div">
                @foreach ($creator as $item)
                    @php
                        $user_bids = App\Models\PlaceBid::where('item_id',$item->id)->get();
                    @endphp
                    @foreach ($user_bids as $bid)
                    <a
                    href="{{ route('item_details',$bid->getItem->slug) }}"
                    ...
                    <figure class="mr-5 self-start">
                        <img src="{{ asset('/uploads/items') }}/{{ $bid->getItem->image }}" alt="avatar 2" class="rounded-2lg" loading="lazy" width="100"/>
                    </figure>
                    ...
                    <div>
                        ...
                        <span class="text-jacarta-500 mb-3 block text-sm">Bidder: {{ $bid->getUser->name }} </span>
                        <span class="text-jacarta-500 mb-3 block text-sm">Bid: {{ $bid->bid_amount }} ETH</span>
                        <span class="text-jacarta-300 block text-xs">{{ $bid->created_at->diffForHumans() }}</span>
                    </div>
                ...
                {{-- <a
                  ...
                  class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
                  <figure class="mr-5 self-start">
                    <img src="{{ asset('frontend_assets') }}/img/products/item_21_sm.jpg" alt="item 2" class="rounded-2lg" loading="lazy" />
                  </figure>
                  ...
                  <div>
                    ...
                    <span class="text-jacarta-500 mb-3 block text-sm">listed by 051_Hart .08095 ETH</span>
                ...
                <a href="item.html"
                  class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
                  <figure class="mr-5 self-start">
                    <img src="{{ asset('frontend_assets') }}/img/products/item_22_sm.jpg" alt="item 3" class="rounded-2lg" loading="lazy" />
                  </figure>
                  ...
                  <div>
                    ...
                    <span class="text-jacarta-500 mb-3 block text-sm">tranferred from 027ab52</span>
                ...
                <a href="item.html"
                  class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
                  <figure class="mr-5 self-start">
                    <img src="{{ asset('frontend_assets') }}/img/products/item_23_sm.jpg" alt="item 3" class="rounded-2lg" loading="lazy" />
                  </figure>
                  ...
                  <div>
                    ...
                    <span class="text-jacarta-500 mb-3 block text-sm">bid cancelled by 0397fd</span>
                ...
                <a href="item.html"
                  class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
                  <figure class="mr-5 self-start">
                    <img src="{{ asset('frontend_assets') }}/img/products/item_24_sm.jpg" alt="item 3" class="rounded-2lg" loading="lazy" />
                  </figure>
                  ...
                  <div>
                    ...
                    <span class="text-jacarta-500 mb-3 block text-sm">liked by Trina_more</span>
              ...
              <div class="mb-10 shrink-0 basis-8/12 space-y-5 lg:mb-0 lg:pr-10 like_div">
                   ...
                   @php
                    ...
                    <a
                    href="{{ route('item_details',$like->getItem->slug ?? '') }}"
                    class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
                    <figure class="mr-5 self-start">
                        <img src="{{ asset('/uploads/items') }}/{{ $like->getItem->image ?? 'default.jpg'}}" alt="avatar 2" class="rounded-2lg" loading="lazy" width="100"/>
                    </figure>

                    <div>
                        <h3 class="font-display text-jacarta-700 mb-1 text-base font-semibold dark:text-white">
                        {{ $like->getItem->name ?? 'N/A'}}
                        </h3>
                        <span class="text-jacarta-500 mb-3 block text-sm">Liker: {{ $like->get_liker->name ?? 'N/A'}} </span>
              ...
              <div class="mb-10 shrink-0 basis-8/12 space-y-5 lg:mb-0 lg:pr-10 report_div">
                    @foreach ($creator as $item)
                    @php
                        $reports = App\Models\ItemProblem::where('item_id',$item->id)->get();
                    @endphp
                        @foreach ($reports as $repo)
                        <a href="{{ route('item_details', $repo->getItem->slug ?? '') }}"
                        class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
                        <figure class="mr-5 self-start">
                            <img src="{{ asset('/uploads/items') }}/{{ $repo->getItem->image ?? 'default.jpg'}}" alt="avatar 2" class="rounded-2lg" loading="lazy" width="100"/>
                        </figure>

                        <div>
                            <h3 class="font-display text-jacarta-700 mb-1 text-base font-semibold dark:text-white">
                            {{ $repo->getItem->name ?? 'N/A'}}
                            </h3>
                            <span class="text-jacarta-500 mb-3 block text-sm">Reporter: {{ $repo->getUser->name ?? 'N/A'}} </span>
                            <span class="text-jacarta-500 mb-3 block text-sm">Report: {{ $repo->getProblem->problem ?? 'N/A'}} </span>
              ...
              <aside class="basis-4/12 lg:pl-5">
                ...
                <div class="flex flex-wrap">
                  ...
                  <button class="bid_filter hover-color dark:border-jacarta-600 dark:bg-jacarta-700 group dark:hover:bg-accent hover:bg-accent border-jacarta-100 mr-2.5 mb-2.5 inline-flex items-center rounded-xl border bg-white px-4 py-3 hover:border-transparent hover:text-white dark:text-white dark:hover:border-transparent">
                    <svg xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="24"
                      height="24"
                  ...
                  <button
                    class="like_filter dark:border-jacarta-600 dark:bg-jacarta-700 group dark:hover:bg-accent hover:bg-accent border-jacarta-100 mr-2.5 mb-2.5 inline-flex items-center rounded-xl border bg-white px-4 py-3 hover:border-transparent hover:text-white dark:text-white dark:hover:border-transparent" >
                    <svg xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="24"
                      height="24"
                  ...
                  <button  class="report_filter dark:border-jacarta-600 dark:bg-jacarta-700 group dark:hover:bg-accent hover:bg-accent border-jacarta-100 mr-2.5 mb-2.5 inline-flex items-center rounded-xl border bg-white px-4 py-3 hover:border-transparent hover:text-white dark:text-white dark:hover:border-transparent" >
                    <svg  xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      width="24"
                      height="24"
...
@section('js')
    <script>
        $(document).ready(function () {
            $('.filterByUser').click(function (){
                ...
                $.ajax({
                    url: "{{ route('filterByCategoryInUser') }}",
                    type: "POST",
                    data: {
                        cat_id: cat_id,
                        user_id: user_id,
                    ...
                    success: function (data){
                        $('#filterByCategoryDiv').html(data.data);
                    }
                });
            });
            ...
            $('#priceFilterBtn').on('click', function(){
                ...
                $('.category_active').each(function(){
                    if($(this).hasClass('active_cat_class')){
                ...
                $.ajax({
                    url: "{{ route('filterCategoryByRange') }}",
                    type: 'post',
                    data: {
            ...
            $('#RecentlyAddedUser').click(function (){
            ...
            $(".dropdown__text__cat").on("click", function(){
                $(".dropdown__cat__text").text($(this).text());
            });
            ...
            $(".dropdown__text__cat").on("click", function(){
                $(".dropdown__text__cat").removeClass("active_cat_class");
                $(this).addClass("active_cat_class");
            });

            $(".dropdown .dropdown__text").on("click", function(){
                $(this).closest(".dropdown").find(".dropdown-toggle__text").text($(this).text());
            });

            $('.like_user_btn').click(function(){
                let creator_id = $(this).attr('creator_id');
                // alert(creator_id)
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                ...
                $.ajax({
                    ...
                    success: function(response){
                        // console.log(response)
                        $(".likeUserCount").html(response.count);
                        if (response.status != 200) {
                            $('.like_user_icon').html(`<i class="fa-regular fa-heart"></i>`);
                            alertify.set('notifier','position', 'top-right');
                            alertify.error(response.message);
                        } else {
                            $('.like_user_icon').html(`<i class="fa fa-heart"></i>`);
                            alertify.set('notifier','position', 'top-right');
                            alertify.success(response.message);
                        }
                    },
    ...
    <script>
        ...
        $('.like_filter').click(function(){
            ...
            $('.bid_div').hide()
            $('.bid_filter').removeClass('hover-color')
            $('.report_div').hide()
            $('.report_filter').removeClass('hover-color')
        })
        $('.bid_filter').click(function(){
            $('.bid_div').show()
            $('.bid_filter').addClass('hover-color')
            $('.like_div').hide()
