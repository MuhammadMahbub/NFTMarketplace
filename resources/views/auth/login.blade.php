            ...
            <div class="lg:flex lg:h-full">
                ...
                <div class="w-full max-w-[25.625rem] text-center">
                    ...
                    <div class="tab-pane fade show active" id="ethereum" role="tabpanel" aria-labelledby="ethereum-tab">
                        <form class="bg-dark shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('login') }}">
                            @csrf
                            ...
                            <div class="flex items-center justify-center space-x-4">
                                <button
                                    ...
                                    class="placeBidBtn loginFromBid loginFrom__Bid bg-accent shadow-accent-volume hover:bg-accent-dark rounded-full py-3 px-8 text-center font-semibold text-white transition-all"
                                    >
                                    {{ __('Login') }}
                            </button>
                            </div>
