                    ...
                    <div class="card-body">
                        <form action="{{ route('update_user_profile', $user->id) }}" method="POST" enctype="multipart/form-data" class="form form-vertical">
                            ...
                            @method('PUT')
                                ...
                                @enderror
                                <div class="form-group">
                                    <label for="username"> Bio <span class="text-danger">*</span></label>
                                ...
                                @enderror
                                <div class="form-group">
                                    <label for="waller_address"> Wallet Address <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <label for="cover_photo_path">Previous Profile Photo</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <label for="cover_photo_path">Previous Cover Photo</label>
                                        <img style="width:100%" src="{{ asset('uploads/images/users') }}/{{ $user->cover_photo_path }}" alt="image">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary mr-1 mt-2">Update User Data</button>
                                </div>
                            </div>
                        </form>
                    </div>
