        ...
        <div class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl block border bg-white p-[1.1875rem] transition-shadow hover:shadow-lg">
            ...
            <div class="absolute left-3 -bottom-3">
                ...
                <a href="{{ route('user', $item->get_creator->id ?? '') }}">
                    <img src="{{ asset('uploads/images/users') }}/{{ $item->get_creator->profile_photo_path ?? 'default.jpg'}}" alt="creator" class="dark:border-jacarta-600 hover:border-accent dark:hover:border-accent h-6 w-6 rounded-full border-2 border-white"  data-tippy-content="Creator: {{ $item->get_creator->name ?? "N/A" }}"/>
                </a>
                <a href="#">
                    <img src="{{ asset('uploads/images/users') }}/{{ $item->get_owner->profile_photo_path ?? 'default.jpg' }}" alt="owner"
            ...
            <div class="dark:hover:bg-jacarta-600 dropup hover:bg-jacarta-100 roundewd-full">
                <a
                href="#"
                ...
                data-bs-target="#placeBidModal_{{ $item->id }}"
            ...
            <span class="dark:text-jacarta-200 text-jacarta-700 mr-5">{{ $item->price ?? ''}} {{ $item->blockchain }}</span>
            <span class="dark:text-jacarta-300 text-jacarta-500 ml-5">{{ $item->quantity ?? '' }}-{{ __('Available') }}</span>
            </div>
            ...
            <a href="{{ route('item_details', $item->slug ?? '') }}" class="group flex items-center">
                ...
                >{{ $item->view_button_text ?? 'Buy Now' }}</span
                >
            </a>
            </div>
        </div>
