          ...
          <div class="card-body">
            <form method="POST" action="{{ route('help_center_title.update') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="help_center_title">Help Center Title <span class="text-danger"> *</span></label>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-9">
                            <label for="bg_image">Background Image <span class="text-danger"> *</span></label>
                ...
                @enderror
                <div class="form-group">
                    <label for="faq_meta_title">Faq Meta Title <span class="text-danger"> *</span></label>
