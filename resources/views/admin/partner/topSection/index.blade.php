...
{{-- Title --}}
@section('title')
    {{ config('app.name') }} | Partner Top Section
            ...
            <div class="col-md-12 m-auto">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> Update Partner Top Section</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-11">
                                    <div class="form-group">
                                        <label for="icon1">Icon One</label>
                                ...
                                <div class="col-11">
                                    <div class="form-group">
                                        <label for="icon2">Icon Two</label>
                                ...
                                <div class="col-11">
                                    <div class="form-group">
                                        <label for="icon3">Icon Three</label>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="text3">Text Three</label>
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary mr-1">Update Partner Top</button>
                                </div>
                            </div>
                        </form>
                    </div>
